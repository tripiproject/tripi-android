package com.tripi.wallet.utils.crypto;
...
public class KeyStoreHelper {
    ...
    public final static String TRIPI_PIN_ALIAS = "tripi_alias";

    public static String getSeed(Context context, @NonNull String pin) {
        String cryptoSaltPassphrase = TripiSharedPreference.getInstance().getSeed(context);

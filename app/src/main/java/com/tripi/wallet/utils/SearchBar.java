...
public class SearchBar extends RelativeLayout implements View.OnClickListener{
    ...
    private void build(){
        setClickable(true);
        placeholderIcon = (ImageView) findViewById(com.tripi.wallet.R.id.icon);
        placeholderText = (TextView) findViewById(com.tripi.wallet.R.id.text);
        input = (EditText) findViewById(com.tripi.wallet.R.id.input);
        placeholder = (LinearLayout) findViewById(com.tripi.wallet.R.id.placeholder);
        cancel = (Button) findViewById(com.tripi.wallet.R.id.cancel);

        clearSearch = (ImageView) findViewById(com.tripi.wallet.R.id.bt_clear_search);

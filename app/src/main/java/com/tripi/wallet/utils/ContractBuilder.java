...
import com.tripi.wallet.utils.sha3.Keccak;
import com.tripi.wallet.utils.sha3.Parameters;
...
public class ContractBuilder {
    ...
    public String createTransactionHash(Script script, List<UnspentOutput> unspentOutputs, int gasLimit, int gasPrice, BigDecimal feePerKb, String feeString, String sendToContractString,Context context, String passphrase) {
        ...
        try {
            ...
            throw new RuntimeException(mContext.getString(com.tripi.wallet.R.string.invalid_tripi_address));
        }
        ...
        if (minimumFee.doubleValue() > fee.doubleValue()) {
            throw new RuntimeException(context.getString(R.string.insufficient_fee_lease_use_minimum_of) + " " + minimumFee.toString() + " TRIPI");
        }
    ...
    public static boolean checkForValidityTRC20(String abiCode) {

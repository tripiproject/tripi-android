...
import com.tripi.wallet.utils.EditTextValidated;
...
public abstract class InputViewHolder extends RecyclerView.ViewHolder implements EditTextValidated.EditTextValidateListener {
    ...
    @BindView(com.tripi.wallet.R.id.til_param)
    protected
    TextInputLayout tilParam;

    @BindView(com.tripi.wallet.R.id.et_param)
    protected
    EditTextValidated etParam;

    @BindView(com.tripi.wallet.R.id.checkbox)

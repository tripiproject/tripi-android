...
import com.tripi.wallet.utils.SearchBar;
import com.tripi.wallet.utils.SearchBarListener;
...
public abstract class SubscribeTokensFragment extends BaseFragment implements SubscribeTokensView, SearchBarListener {
    ...
    @BindView(com.tripi.wallet.R.id.recycler_view)
    protected
    RecyclerView mRecyclerView;

    @BindView(com.tripi.wallet.R.id.tv_currency_title)
    TextView mTextViewCurrencyTitle;

    @BindView(com.tripi.wallet.R.id.search_bar)
    SearchBar searchBar;
    ...
    public void initializeViews() {
        ...
        mTextViewCurrencyTitle.setText(com.tripi.wallet.R.string.chose_to_subscribe);
    ...
    class TokenHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(com.tripi.wallet.R.id.iv_check_indicator_blue)

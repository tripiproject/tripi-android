...
import com.tripi.wallet.utils.FileUtils;
import com.tripi.wallet.utils.FontCheckBox;
...
public abstract class RestoreContractsFragment extends BaseFragment implements RestoreContractsView {
    ...
    @BindView(com.tripi.wallet.R.id.rl_back_up_file)
    protected
    FrameLayout mFrameLayoutBackUpFile;
    @BindView(com.tripi.wallet.R.id.cb_restore_templates)
    FontCheckBox mCheckBoxRestoreTemplates;
    @BindView(com.tripi.wallet.R.id.cb_restore_contracts)
    FontCheckBox mCheckBoxRestoreContracts;
    @BindView(com.tripi.wallet.R.id.cb_restore_tokens)
    FontCheckBox mCheckBoxRestoreTokens;
    @BindView(com.tripi.wallet.R.id.cb_restore_all)
    FontCheckBox mCheckBoxRestoreAll;

    @BindView(com.tripi.wallet.R.id.tv_select_back_up)
    protected
    FontTextView mTextViewFileName;
    @BindView(com.tripi.wallet.R.id.tv_file_size)
    protected
    FontTextView mTextViewFileSize;
    @BindView(com.tripi.wallet.R.id.iv_restore_icon)
    protected
    ImageView mImageViewRestoreIcon;

    @OnClick({com.tripi.wallet.R.id.rl_back_up_file, com.tripi.wallet.R.id.cb_restore_templates, com.tripi.wallet.R.id.cb_restore_contracts, com.tripi.wallet.R.id.cb_restore_tokens, com.tripi.wallet.R.id.cb_restore_all, com.tripi.wallet.R.id.iv_restore_icon, com.tripi.wallet.R.id.ibt_back, com.tripi.wallet.R.id.bt_restore})
    public void onClick(View view) {
        switch (view.getId()) {
            case com.tripi.wallet.R.id.rl_back_up_file:
                ...
                break;
            case com.tripi.wallet.R.id.iv_restore_icon:
                ...
                break;
            case com.tripi.wallet.R.id.cb_restore_templates:
                ...
                break;
            case com.tripi.wallet.R.id.cb_restore_contracts:
                ...
                break;
            case com.tripi.wallet.R.id.cb_restore_tokens:
                ...
                break;
            case com.tripi.wallet.R.id.cb_restore_all:
            ...
            case com.tripi.wallet.R.id.ibt_back:
                ...
                break;
            case com.tripi.wallet.R.id.bt_restore:
                if (mCheckBoxRestoreAll.isChecked()) {

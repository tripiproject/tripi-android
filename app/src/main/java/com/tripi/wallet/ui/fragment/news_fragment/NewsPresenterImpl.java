...
public class NewsPresenterImpl extends BaseFragmentPresenterImpl implements NewsPresenter {
    ...
    public void onRefresh() {
        if (mNetworkConnectedFlag) {
            ...
            getView().setAlertDialog(com.tripi.wallet.R.string.no_internet_connection,
                    com.tripi.wallet.R.string.please_check_your_network_settings,
                    com.tripi.wallet.R.string.ok,

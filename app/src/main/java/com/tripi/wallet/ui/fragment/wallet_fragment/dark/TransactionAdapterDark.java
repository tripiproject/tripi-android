...
import com.tripi.wallet.ui.fragment.wallet_fragment.TransactionAdapter;
...
public class TransactionAdapterDark extends TransactionAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_TRANSACTION) {
            ...
            View view = layoutInflater.inflate(com.tripi.wallet.R.layout.item_transaction, parent, false);

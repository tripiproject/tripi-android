package com.tripi.wallet.ui.fragment.subscribe_tokens_fragment.dark;
...
public class SubscribeTokensFragmentDark extends SubscribeTokensFragment {
    ...
    protected int getLayout() {
        return com.tripi.wallet.R.layout.fragment_currency;
    }
    ...
    public void setTokenList(List<Token> tokenList) {
        ...
        mTokenAdapter = new TokenAdapter(tokenList, com.tripi.wallet.R.layout.item_single_checkable);

package com.tripi.wallet.dataprovider.services.update_service;
...
import com.tripi.wallet.dataprovider.firebase.FirebaseSharedPreferences;
import com.tripi.wallet.dataprovider.firebase.listeners.FireBaseTokenRefreshListener;
...
import com.tripi.wallet.utils.BoughtContractBuilder;
...
import com.tripi.wallet.dataprovider.services.update_service.listeners.TransactionListener;
...
import static com.tripi.wallet.WearListCallListenerService.ADDRESS;
import static com.tripi.wallet.WearListCallListenerService.BALANCE;
import static com.tripi.wallet.WearListCallListenerService.CURR_TIME_MILLS;
import static com.tripi.wallet.WearListCallListenerService.ITEMS;
import static com.tripi.wallet.WearListCallListenerService.UNC_BALANCE;
import static com.tripi.wallet.utils.StringUtils.convertBalanceToString;
...
public class UpdateService extends Service implements GoogleApiClient.ConnectionCallbacks {
    ...
    public void onCreate() {
        ...
        final TripiSharedPreference tripiSharedPreference = TripiSharedPreference.getInstance();

        String balanceString = tripiSharedPreference.getBalanceString(getApplicationContext());
        final String unconfirmedBalanceString = tripiSharedPreference.getUnconfirmedBalanceString(getApplicationContext());
        Long lastUpdatedBalanceTime = tripiSharedPreference.getLastUpdatedBalanceTime(getApplicationContext());
            ...
            public void call(Object... args) {
                try {
                    ...
                    try {
                        ...
                        tripiSharedPreference.setBalanceString(getApplicationContext(), balance.toString());
                        tripiSharedPreference.setUnconfirmedBalanceString(getApplicationContext(), unconfirmedBalance.toString());
                        tripiSharedPreference.setLastUpdatedBalanceTime(getApplicationContext(), mLastUpdatedBalanceTime);
    ...
    private void onBalanceChange() {
        TripiService.newInstance().getHistoryListForSeveralAddresses(addresses, 10, 0)

...
public class FileStorageManager {
    ...
    private final static String TRC20TOKENSTANDART = "TRC20TokenStandard";
    ...
    private final static String TRC20TOKENSTANDARTUUID = "trc20-token-identifire";
    private final static String CROWDSALEUUID = "crowdsale-identifire";
    private static String[] STANDARD_CONTRACTS = {CROWDSALE, HUMANSTANDARDTOKEN, TRC20TOKENSTANDART};
    private static String[] STANDARD_UUIDS = {CROWDSALEUUID, HUMANSTANDARDTOKENUUID, TRC20TOKENSTANDARTUUID};
